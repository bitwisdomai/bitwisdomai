...
13. Calculations
 ...
 • **[50 players]** → indexed set of agents (or onboarded
 merchants of all nodes worldwide)\
 • **[Player talent]** → weighted ranking score (or
 weighted threshold fund amounts for merchants ready to settle)\
 • **[Coach decisions]** → selection function (AI
 decision-making of order for which merchant thresholds settle at what
 timing)\
 • [**Game clock**] → finite resource constraint (AI time
 constraints/thresholds of settlement)\
 • **[Winning comfortably]** → increasing fairness
 allocation\
 • **[Late-game substitutions]** → probability
